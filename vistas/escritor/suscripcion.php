...
class Suscripcion{
    ...
    public function ingresarSuscripcion(){
        ...
        if($reg=mysqli_fetch_array($registro)){
            echo "<div class='falloSuscripcion'> Aceptar<a href='../vistas/escritor/descubrete.php'>Aceptar</a></button></div>'";
           }else{
           ...
           echo "<div class='falloSuscripcion'> Se registro correctamente la suscripcion <a href='../vistas/escritor/descubrete.php'>Aceptar</a></button></div>'";
           }
    }
    ...
    public function ingresarSuscripcion2(){
        ...
        where correo = '$this->correo'") or die (mysqli_error($this->conectorBD()));
        if($reg=mysqli_fetch_array($registro)){
            echo "<div class='falloSuscripcion'> La suscripcion ya existe <a href='../vistas/escritor/descubrete.php'><button type='button'>Aceptar</button></a></div>";
           }else{
            $fecha= date('Y-m-d', strtotime('-1 day'));
           ...
           values ('$this->correo', '$this->tipoSub','$this->costo','$fecha', '$fechaFin')") or die
           ("Problemas en el insert".mysqli_error($this->conectorBD()));
           echo "<div class='falloSuscripcion'> Se registro correctamente la suscripcion <a href='../vistas/escritor/descubrete.php'><button type='button'>Aceptar</button></a></div>";
           }
    }
