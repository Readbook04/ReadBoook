...
<body>
    <header class="encabezado">
        ...
        <nav class="navegador2">
            ...
            <ul class="menu">
                <li><a href="libros.php">libros</a></li>
                <li><a id="esta" href="consultarLector.php">Descubrete</a></li>
                <li><a href="soporte.html">Soporte</a></li>
                <li><a href="contacto.html">Contactos</a></li>
                <li><a href="../../html/suscribirse.html">Suscribirse</a></li>
                <li><a href="../../html/iniciar-sesion.html">Cerrar Sesión</a></li>
            ...
            <div class="formularioConsultar">
                <?php
                    ...
                    switch($_REQUEST['opcion']){
                        case 1:
                            $Escritor->modificarDatos($_REQUEST['correo']);
                            break;
                        case 2:
                            $foto = isset($_FILES['foto']['tmp_name']) ? file_get_contents($_FILES['foto']['tmp_name']) : null;
                           $Escritor->modificar2($_REQUEST['foto'],$_REQUEST['nombre'],$_REQUEST['apellido_paterno'],$_REQUEST['apellido_materno'],$_REQUEST['biografia'],$_REQUEST['tipo'],$_REQUEST['telefono'],$_REQUEST['correo'], $_REQUEST['contraseña']);
                            break;
                    }
                ?>
            </div>
