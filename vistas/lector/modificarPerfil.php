            ...
            <div class="formulario01">
                <?php
                    ...
                    switch($_REQUEST['opcion']){
                        case 1:
                            $usuarios->modificarDatos($_REQUEST['correo']);
                            break;
                        case 2:
                           $usuarios->modificar2($_REQUEST['nombre_usuario'],$_REQUEST['apellidoPaterno'],$_REQUEST['apellidoMaterno'],$_REQUEST['correo'],$_REQUEST['contraseña'],$_REQUEST['tipo']);
                            break;
                    }
                ?>
            </div>
