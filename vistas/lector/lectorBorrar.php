...
<body>
    <header class="encabezado">
        <div class="logo2">    
            <a class="logo" href="perfilLector.php"><img src="../../img/logo-removebg-preview (1).png" alt=""></a>
        </div>
        <nav class="navegador">
            <div class="logo1">
                <a href="perfilLector.php"><img src="../../img/logo-removebg-preview (1).png" alt=""></a>
            </div>    
            <ul class="menu">
            <li><a href="libros.php">Libros</a></li>
                <li><a href="consultarLector.php">Descubrete</a></li>
    ...
    <main>
       ...
       $usuarios->conectorBD();
       $usuarios->lectorBorrar($_REQUEST['correo']);
       ?>
