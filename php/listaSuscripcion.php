...
<body>
    ...
    <nav class="navegador">
        <div class="logo1">
            <a href="../vistas/admin/adminLibros.php"><img src="../../img/logo-removebg-preview (1).png" alt=""></a>
        </div>
        <ul class="menu">
        <li><a href="../vistas/admin/adminLibros.php">libros</a></li>
            <li><a href="../vistas/admin/adminGeneros.php">Generos</a></li>
            <li><a href="listaSuscripcion.php">Suscipciones</a></li>
    ...
    <nav class="navegador2">
        ...
        <ul class="menu">
            ...
            <li><a id="esta" href="descubrete.html">Suscipciones</a></li>
