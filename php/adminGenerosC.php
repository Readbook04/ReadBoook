...
<header class="encabezado">
    ...
    <nav class="navegador">
        ...
        <ul class="menu">
            <li><a href="../vistas/adminLibro">libros</a></li>
...
<main class="admin">
    <?php
    include_once "adminGeneros.php";
    $gen = new Genero();
     if (isset($_REQUEST['opcion'])){
        switch($_REQUEST['opcion']){
            case 1:
                $gen->inicializar($_REQUEST['Genero']);
                $gen->agregarGenero();
            break; 

            case 2:
               $gen->eliminarGenero($_REQUEST['id_genero']);
            break;
            
            case 3;
                $gen->modificar1($_REQUEST['id_genero']);
            break;

            case 4: 
                $gen->modificar2($_REQUEST['Genero'],$_REQUEST['id_genero']);
            break;

            case 5:
                $gen->consultarGenero($_REQUEST['consultar']);
            break;
         }
