...
class Libro
{
    ...
    public function agregarLibro()
    {
        ...
        if ($val = mysqli_fetch_array($validar)) {
            echo '<div class="falloPublicar">Ya existe este libro <button><a href="../vistas/escritor/descubrete.php">Aceptar</a></button></div>';
        } else {
            $fecha = date('Y-m-d');
            ...
            echo '<div class="falloPublicar">Libro Publicado <button><a href="../vistas/escritor/descubrete.php">Aceptar</a></button></div>';
        }
    }
    ...
    public function eliminarLibro($id)
    {
        ...
        if ($reg = mysqli_fetch_array($registro)) {
            ...
            <section class="publicarLiContenedor">
                ...
                <form>
                        ...
                        <div class="publicarForm">
                            ...
                            <input type="text" name="titulo" id="ti" value="' . $reg['titulo'] . '" disabled>
                            <label for="nom">Autor</label>
                            <input type="text" name="autor" id="nom" value="' . $reg['autor'] . '" disabled>
                            <label for="hor">Fecha</label>
                            <p id="fecha" value="' . $reg["fecha_publicacion"] . '"></p>
                            <label for="sinop">Sinopsis</label>
                            <textarea disabled>' . $reg['sinopsis'] . '</textarea>
                            <label for="gen">Genero</label>
                            <input type="text" name="autor" id="nom" value="' . $reg[9] . '" disabled>
                    ...
                    <div class="publicar-botones">
                        <button class="botones"><a href="../vistas/escritor/descubrete.php">Aceptar</a></button>
                    </div>
                </form>
                </div>
            </section>';
            ...
            echo '<div class="falloPublicar">El libro fue borrado<button><a href="../vistas/escritor/descubrete.php">Aceptar</a></button></div>';
        }
    }
    ...
    public function mostrarLibro($genero)
    {
        ...
        echo '<h1>Libros</h1>
        <h3>Genero</h3>
        <form action="adminLibroControl" method="post">
        <select name="genero" id="">';
        include_once "../vistas/admin/publicarLibro.php";
        $lib = new adminLibro();
        $lib->listarGeneros();
        $lib->cerrarBD();
        echo '</select>
        ...
        echo '<table><tr><th>Codigo</th><th>Foto</th><th>Autor</th><th>Titulo</th><th>Sinopsis</th><th>Fecha de Publicacion</th><th>Libro</th><th>Genero</th><th colspan="3">Acciones</th></tr>';
    ...
    public function modificar1($id)
    {
        ...
        if ($reg = mysqli_fetch_array($registro)) {
            ...
            <section class="publicarLiContenedor">
                ...
                <div class="publicarLiForm">
                    <form action="librosControl.php" method="post" enctype="multipart/form-data">
                        <div class="publicarLiPortada">
            ...
            echo '</select>
                        ...
                        <div></div>
                        <div class="publicar-botones">
                            <button class="botones"><a href="../vistas/escritor/descubrete.php">Cancelar</a></button>
    ...
    public function modificar2($portada, $titulo, $autor, $sinopsis, $genero, $libro, $id){
        ...
        echo '<div class="falloPublicar">El libro fue Modificado<button><a href="../vistas/escritor/descubrete.php">Aceptar</a></button></div>';
    }
    ...
    public function tablaLibros()
    {
        ...
        echo '<table class = "libros-Pu"><a href = "../../vistas/escritor/publicarLibro.php"><i class="fa-solid fa-book-medical"></i>Agregar Libro</a>';
        echo '<tr><th>Codigo</th><th>Foto</th><th>Autor</th><th>Titulo</th><th>Sinopsis</th><th>Fecha de Publicacion</th><th>Libro</th><th>Genero</th><th colspan="2">Acciones</th></tr>';
        while ($reg = mysqli_fetch_array($registros)) {
            ...
            echo "<td>" . '<img src="../../img/pdf.png">' . "</td>";
            echo "<td>" . $reg[9] . "</td>";
            echo '<td><form action="../../php/librosControl.php" method="post">
            <input type="hidden" name="opcion" value="4">
            <input type="hidden" name="id_libro" value="' . $reg[0] . '">
            <input type="submit" value="Modificar" id="verde">
        </form></td>';
    ...
    public function listarLibros(){
        $registros = mysqli_query($this->conexionBD(), "SELECT * FROM libros")or die("No se encontro ningun libro".mysqli_error($this->conexionBD()));
        ...
        while($reg = mysqli_fetch_array($registros)){
            ...
            echo '<tr>
                    <td>
                    <img src="data:image/png;base64,' . base64_encode($reg[1]) . '">
                    </td>
                    <td>
                    '.$reg[3].'
                    </td>
                    <td>
                    <a href="data:application/pdf;base64,' . base64_encode($reg['libro']) . '" target="_blank"">Leer</a>
                    </td>
                </tr>';   
        }
